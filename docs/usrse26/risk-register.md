...
| R14 | EKS demonstration exceeds the planned exposure | Low | High | `TIME_BOUNDED`; concrete estimate <= USD 200 before apply; fixed capacity; 72-hour deadline; primary and independent backup stop; exact-tag sweep | planning estimate, schedule/deadline evidence, zero inventory; optional human-reconciled actual billed cost | Open |
